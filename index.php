...
<?php include 'hero.html'; ?>
        <section class="container__content">
            ...
            <div class="title">
                <h1>Historia</h1>
                <p>Películas terroríficas que no puedes dejar de ver</p>
                <div class="title__under"></div>
            </div>
            <div class="carousel">
        ...
        <section class="schedule">
            <div class="schedule__content">
                ...
                <nav class="tabbar">
                    <ul>
                        <li class="active fifteen_day"><a href="" ><span>15 Octubre</span></a></li>
                        <li class="seventeen_day"><a href=""><span>17 Octubre</span></a></li>
                        <li class="twentytwo_day"><a href=""><span>22 Octubre</span></a></li>
                    </ul>
                </nav>
                <div id="schedule__calendar">
                    <ul id="fifteen_day" class="schedule__list show">
                        <li class="schedule__item">
                            <h3>El Exorcista</h3>
                            <div class="schedule__desc">
                                <p>Sala 4, Málaga, Plaza Mayor</p>
                        ...
                        <li class="schedule__item">
                            ...
                            <div class="schedule__desc">
                                <p>Sala 11, Málaga, Plaza Mayor</p>
                                <span class="material-symbols-outlined schedule__forward">arrow_forward_ios</span>
                            </div>
                        ...
                        <li class="schedule__item">
                            <h3>El resplandor</h3>
                            <div class="schedule__desc">
                                <p>Sala 1, Málaga, Centro Larios.</p>
                                <span class="material-symbols-outlined schedule__forward">arrow_forward_ios</span>
                            </div>
                    ...
                    <ul id="seventeen_day" class="schedule__list hide">
                        <li class="schedule__item">
                            <h3>Posesión Infernal</h3>
                            <div class="schedule__desc">
                                <p>Sala 3, Málaga, Plaza Mayor</p>
                                <span class="material-symbols-outlined schedule__forward">arrow_forward_ios</span>
                            </div>
                            <p class="schedule__hour">23:00</p>
                            <a href="#" class="btnSecondary__schedule">Ver butacas</a>
                    ...
                    <ul id="twentytwo_day" class="schedule__list hide">
                        ...
                        <li class="schedule__item">
                            <h3>Frankenstein</h3>
                            <div class="schedule__desc">
                                <p>Sala 10, Málaga, Plaza Mayor</p>
                                <span class="material-symbols-outlined schedule__forward">arrow_forward_ios</span>
                            </div>
                            <p class="schedule__hour">20:30</p>
                            <a href="#" class="btnSecondary__schedule">Ver butacas</a>
