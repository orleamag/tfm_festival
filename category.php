            ...
            <div class="category__content">
                <nav class="tabbar">
                    <ul class="category" >
                        ...
                        <li class="award"><a href=""><span>Galardonadas</span></a></li>
                        <li class="psicology"><a href=""><span>Psicológicas</span></a></li>
                        <li class="psicology"><a href=""><span>Sobrenatural</span></a></li>
                        <li class="psicology"><a href=""><span>Maldición</span></a></li>
                        <li class="psicology"><a href=""><span>Slasher</span></a></li>
                        <li class="psicology"><a href=""><span>Horror</span></a></li>
                        <li class="psicology"><a href=""><span>Infantiles</span></a></li>
                    </ul>
                </nav>
                <section id="category__cards">
                    ...
                    <!-- <div id="history" class="category__filter show">
